...
2. Fault Tolerance - Uses Erasure Coding to Optimize data replication - Seeks contribution for design - [Discussion](https://github.com/cia-labs/Storage-service/issues/72)
   - Practical/Product use case: Vitality Console dataset and model-artifact storage needs resilient replicas so training and inference workloads can recover from node or disk failures.
...
5. Availability - Seeks contribution for design (issue to be created).
